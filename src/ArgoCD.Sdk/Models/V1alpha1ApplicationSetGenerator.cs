...
namespace ArgoCD.Sdk.Models
{
    ...
    public partial class V1alpha1ApplicationSetGenerator : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public global::ArgoCD.Sdk.Models.V1alpha1ListGenerator List { get; set; }
#endif
        /// <summary>MatrixGenerator generates the cartesian product of two sets of parameters. The parameters are defined by two nestedgenerators.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ArgoCD.Sdk.Models.V1alpha1MatrixGenerator? Matrix { get; set; }
#nullable restore
#else
        public global::ArgoCD.Sdk.Models.V1alpha1MatrixGenerator Matrix { get; set; }
#endif
        /// <summary>MergeGenerator merges the output of two or more generators. Where the values for all specified merge keys are equalbetween two sets of generated parameters, the parameter sets will be merged with the parameters from the lattergenerator taking precedence. Parameter sets with merge keys not present in the base generator&apos;s params will beignored.For example, if the first generator produced [{a: &apos;1&apos;, b: &apos;2&apos;}, {c: &apos;1&apos;, d: &apos;1&apos;}] and the second generator produced[{&apos;a&apos;: &apos;override&apos;}], the united parameters for merge keys = [&apos;a&apos;] would be[{a: &apos;override&apos;, b: &apos;1&apos;}, {c: &apos;1&apos;, d: &apos;1&apos;}].MergeGenerator supports template overriding. If a MergeGenerator is one of multiple top-level generators, itstemplate will be merged with the top-level generator before the parameters are applied.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ArgoCD.Sdk.Models.V1alpha1MergeGenerator? Merge { get; set; }
#nullable restore
#else
        public global::ArgoCD.Sdk.Models.V1alpha1MergeGenerator Merge { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ArgoCD.Sdk.Models.V1alpha1ApplicationSetGenerator"/> and sets the default values.
        /// </summary>
        public V1alpha1ApplicationSetGenerator()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::ArgoCD.Sdk.Models.V1alpha1ApplicationSetGenerator"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ArgoCD.Sdk.Models.V1alpha1ApplicationSetGenerator CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ArgoCD.Sdk.Models.V1alpha1ApplicationSetGenerator();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "matrix", n => { Matrix = n.GetObjectValue<global::ArgoCD.Sdk.Models.V1alpha1MatrixGenerator>(global::ArgoCD.Sdk.Models.V1alpha1MatrixGenerator.CreateFromDiscriminatorValue); } },
                { "merge", n => { Merge = n.GetObjectValue<global::ArgoCD.Sdk.Models.V1alpha1MergeGenerator>(global::ArgoCD.Sdk.Models.V1alpha1MergeGenerator.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ArgoCD.Sdk.Models.V1alpha1MatrixGenerator>("matrix", Matrix);
            writer.WriteObjectValue<global::ArgoCD.Sdk.Models.V1alpha1MergeGenerator>("merge", Merge);
