...
using System;
namespace ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v1\write-repositories\{repoRepo-id}\validate
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ValidateRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValidateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/write-repositories/{repoRepo%2Did}/validate{?bearerToken*,enableOci*,forceHttpBasicAuth*,gcpServiceAccountKey*,githubAppEnterpriseBaseUrl*,githubAppID*,githubAppInstallationID*,githubAppPrivateKey*,insecure*,insecureOciForceHttp*,name*,password*,project*,proxy*,sshPrivateKey*,tlsClientCertData*,tlsClientCertKey*,type*,useAzureWorkloadIdentity*,username*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ValidateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/write-repositories/{repoRepo%2Did}/validate{?bearerToken*,enableOci*,forceHttpBasicAuth*,gcpServiceAccountKey*,githubAppEnterpriseBaseUrl*,githubAppID*,githubAppInstallationID*,githubAppPrivateKey*,insecure*,insecureOciForceHttp*,name*,password*,project*,proxy*,sshPrivateKey*,tlsClientCertData*,tlsClientCertKey*,type*,useAzureWorkloadIdentity*,username*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::ArgoCD.Sdk.Models.RepositoryRepoResponse?> PostAsync(string body, Action<RequestConfiguration<global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder.ValidateRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ArgoCD.Sdk.Models.RepositoryRepoResponse> PostAsync(string body, Action<RequestConfiguration<global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder.ValidateRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(string body, Action<RequestConfiguration<global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder.ValidateRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(string body, Action<RequestConfiguration<global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder.ValidateRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// ValidateWriteAccess validates write access to a repository with given parameters
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ValidateRequestBuilderPostRequestConfiguration : RequestConfiguration<global::ArgoCD.Sdk.Api.V1.WriteRepositories.Item.Validate.ValidateRequestBuilder.ValidateRequestBuilderPostQueryParameters>
        {
        }
    }
}
